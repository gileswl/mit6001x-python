...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for char in word:         
            if hand.get(char,0) < getFrequencyDict(word)[char]:
                return False
        return True
    else:
        return False
...
def playGame(wordList):
    ...
    while True:
        userchoice = str(input("Enter n to deal a new hand, r to replay the last hand, or e to end game:"))
        ...
        if userchoice == "r":
            while True:
                if handsplayed == 0:
                    ...
                    userchoice2 = str(input("Enter u to have yourself play, c to have the computer play:"))
                    if userchoice2 == "u":
